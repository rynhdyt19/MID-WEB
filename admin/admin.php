...
$total_pages_query = "SELECT COUNT(*) AS total FROM admin_film";
...
$query = "SELECT * FROM admin_film ORDER BY id DESC LIMIT $offset, $records_per_page";
    ...
    <main>
        <section class="widget">
            ...
            <div class="table-container">
                <div class="tombol-tambah"><a href="tambah-data-admin.php">Add <i class="fa-solid fa-plus"></i></a></div>
                <?php
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="tombol-action">
                                        <div class="tombol-update"><a href="tambah-data-admin.php?ubah=<?php echo $result['id'] ?>"><i class="fa-solid fa-pen-to-square"></i> Update</a></div>
                                        <div class="tombol-delete"><a type="button" href="proses-tambah-data-admin.php?hapus=<?php echo $result['id'] ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ?')"><i class="fa-solid fa-trash"></i> Delete</a></div>
                                    </div>
                                </td>
                            </tr>
                        <?php
